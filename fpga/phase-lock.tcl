...
#
# signallab.tcl: Tcl script for re-creating project 'signallab'
#
# Generated by Vivado on Mon Nov 01 21:04:54 AEDT 2021
...
#
# 1. This project restoration tcl script (signallab.tcl) that was generated.
#
...
#    "/home/ryan/projects/phase-lock/fpga/sources/ip/BlockMemory/BlockMemory.xci"
#    "/home/ryan/projects/phase-lock/fpga/sources/ip/DDS_Output/DDS_Output.xci"
...
set files [list \
 ...
 [file normalize "${origin_dir}/sources/ip/DDS_Output/DDS_Output.xci"] \
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/phase-lock/phase-lock.gen/sources_1/bd/system/hdl/system_wrapper.vhd" ]
} else {
...
set file "$origin_dir/sources/ip/DDS_Output/DDS_Output.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/cfg/signal_lab.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7z020clg400-3" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/cfg/signal_lab.xdc"]" -objects $obj
...
set_property -name "top" -value "FF_PLL" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/signallab.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/signallab.srcs/utils_1/imports/impl_1" -objects $obj
