...
#
# phase-lock-250.tcl: Tcl script for re-creating project 'phase-lock-250'
#
# Generated by Vivado on Wed May 31 09:40:49 MDT 2023
...
#
# 1. This project restoration tcl script (phase-lock-250.tcl) that was generated.
#
...
#    "/home/ryan/projects/phase-lock/fpga/cfg/constraints-250.xdc"
...
set file "$origin_dir/sources/rtl/SaveADCData.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "[file normalize "$origin_dir/cfg/constraints-250.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/cfg/constraints-250.xdc"
set file [file normalize $file]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg400-3 -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/phase-lock2.srcs/utils_1/imports/synth_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg400-3 -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/phase-lock2.srcs/utils_1/imports/impl_1" -objects $obj
